          ...
          <table id="example2" class="table table-bordered table-hover">
            ...
            <?php $sno = 1; ?>
                ...
                <tr class="tbl_view text-center" >
                    ...
                    <td>
                        <a href="#" name="prefix" class="prefix" data-type="text" data-pk="<?= $row->id?>" data-url="<?php echo base_url( $this->config->item('index_page') . '/product/updateMake/prefix' ) ?>" data-title="Enter new Prefix"><?=$row->prefix ?></a>
                    </td>
