      ...
      <div class="box">
        ...
        <div class="col-md-12 column"  style = "border-bottom:solid 1px #ddd; margin-bottom:4px; padding-bottom: 5px;" >
            <a id="modal-666931" href="#modal-container-666931" role="button" class="btn btn-default btn-sm" data-toggle="modal">
                <i class="glyphicon glyphicon-plus"></i>&nbsp; Add new Model Item
            </a>&nbsp;
        </div>
        <div class="box-body">
          <table id="example2" class="table table-bordered table-hover">
            ...
            <?php $sno = 1; ?>
                ...
                <tr class="tbl_view text-center" >
                    ...
                    <td>
                        <a href="#" class="is_active" data-type="select" data-pk="<?= $row->id?>" data-url="<?php echo base_url( $this->config->item('index_page') . '/product/updateModel/is_active' ) ?>" data-title="Select status"><?php echo $row->is_active == '1' ? 'Active' : 'Inactive' ?></a>
                    </td>
                    <td>
                        <a href="#" class="shop" data-type="select" data-pk="<?= $row->id?>" data-url="<?php echo base_url( $this->config->item('index_page') . '/product/updateModel/shop' ) ?>" data-title="Select Shop"><?PHP echo $row->shop; ?></a>
                    </td>
...
<form method="POST" id='delmodel' action="<?php echo base_url( $this->config->item('index_page') . '/product/delModel' ) ?>" >
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form class="form-horizontal cus-form" id="Add_transaction" method="POST" action="<?php echo base_url( $this->config->item('index_page') . '/product/createModel' ) ?>"  data-parsley-validate>
